...
Compare frequencies between RSTR vs. LTBI donors.
...
if(!dir.exists(here::here("out/Treg_CD4_Tcells_Analysis_of_CD4"))) {
  cat(sprintf("Creating folder %s\n", here::here("out/Treg_CD4_Tcells_Analysis_of_CD4")))
  dir.create(here::here("out/Treg_CD4_Tcells_Analysis_of_CD4"), recursive = T)
}
```
...
```{r, fig.width=4, fig.height=5}
treg_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
...
```{r, fig.width=4, fig.height=5}
foxp3_pos_cd25_neg_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
...
names(foxp3_pos_cd25_neg_plots) <- stims
foxp3_pos_cd25_neg_plots
```

# FOXP3-CD25+

```{r, fig.width=4, fig.height=5}
foxp3_neg_cd25_pos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
...
names(foxp3_neg_cd25_pos_plots) <- stims
foxp3_neg_cd25_pos_plots
```

# FOXP3-CD25-

```{r, fig.width=4, fig.height=5}
foxp3_neg_cd25_neg_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
...
names(foxp3_neg_cd25_neg_plots) <- stims
foxp3_neg_cd25_neg_plots
```

# Save plots

```{r}
cairo_pdf(file=here::here("out/Treg_CD4_Tcells_Analysis_of_CD4/Treg_CD4_CD25_plots_of_CD4.pdf"), width=4, height=5,
...
cairo_pdf(file=here::here("out/Treg_CD4_Tcells_Analysis_of_CD4/Treg_CD4_FoxP3_CD25_plots_of_CD4.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(treg_plots[["DMSO"]])
print(treg_plots[["PP1"]])
print(treg_plots[["TB WCL"]])
dev.off()
```
