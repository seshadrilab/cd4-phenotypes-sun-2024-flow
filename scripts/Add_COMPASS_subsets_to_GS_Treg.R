...
gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
           ...
           parent = "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4+", name = "CD4_COMPASS_Subsets")
...
gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
           ...
           parent = "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+", name = "CD8_COMPASS_Subsets")

## Add CCR7+ gate under CD4_COMPASS_Subsets and CD8_COMPASS_Subsets ##
cd4_ccr7_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4+/CCR7+"
cd8_ccr7_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/CCR7+"

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd4_ccr7_path),
           parent = "CD4_COMPASS_Subsets", name = "CCR7+")

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd8_ccr7_path),
           parent = "CD8_COMPASS_Subsets", name = "CCR7+")

## Add IL-10+ gate under CD4_COMPASS_Subsets and CD8_COMPASS_Subsets ##
cd4_il10_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4+/IL10+"
cd8_il10_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/IL10+"

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd4_il10_path),
           parent = "CD4_COMPASS_Subsets", name = "IL10+")

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd8_il10_path),
           parent = "CD8_COMPASS_Subsets", name = "IL10+")

## Add FoxP3+ and CD25+ gates under CD4_COMPASS_Subsets and CD8_COMPASS_Subsets ##
...
cd8_foxp3_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/FOXP3+"
cd8_cd25_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/CD25+"
...
gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd4_cd25_path),
           parent = "CD4_COMPASS_Subsets", name = "CD25+")
...
gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd8_cd25_path),
           parent = "CD8_COMPASS_Subsets", name = "CD25+")

## Add CD39+ and CD73+ gates under CD4_COMPASS_Subsets and CD8_COMPASS_Subsets ##
...
cd8_cd39_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/CD39+"
cd8_cd73_path <- "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD8+/CD73+"
...
gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd4_cd39_path),
           parent = "CD4_COMPASS_Subsets", name = "CD39+")

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd4_cd73_path),
           parent = "CD4_COMPASS_Subsets", name = "CD73+")
...
gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd8_cd39_path),
           parent = "CD8_COMPASS_Subsets", name = "CD39+")

gs_pop_add(gs, lapply(gs, gh_pop_get_gate, y = cd8_cd73_path),
           parent = "CD8_COMPASS_Subsets", name = "CD73+")

## Recompute the gating set with the new gates ##
flowWorkspace::recompute(gs)

# Plot the gating tree
png(here::here("out/Treg_GatingTree_with_COMPASS_Subsets.png"), width = 7, height = 5, units = "in", res = 300)
plot(gs, bool = T, fontsize = 10)
dev.off()

# Save the gating set 
save_gs(gs, here::here("out/GatingSets/RSTR_Treg_GatingSet_with_COMPASS_Subsets"))
