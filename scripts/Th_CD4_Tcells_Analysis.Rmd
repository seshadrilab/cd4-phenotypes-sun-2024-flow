...
gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
                               list(v = as.symbol(paste0("", cd4_ccr7_path,
                                                         "&", cd4_cd45ra_path))))),
           parent = "CD4_CD154+_OR_CD137+", name = "Naive")
...
gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
                               list(v = as.symbol(paste0("", cd4_ccr7_path,
                                                         "&", cd4_cd45ra_path))))),
           parent = "RORyT-TBET-", name = "Naive")

gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
                               list(v = as.symbol(paste0("", cd4_ccr7_path,
                                                         "&!", cd4_cd45ra_path))))),
           parent = "RORyT-TBET-", name = "TCM")

gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
                               list(v = as.symbol(paste0("!", cd4_ccr7_path,
                                                         "&", cd4_cd45ra_path))))),
           parent = "RORyT-TBET-", name = "TEMRA")

gs_pop_add(gs, eval(substitute(flowWorkspace::booleanFilter(v),
                               list(v = as.symbol(paste0("!", cd4_ccr7_path,
                                                         "&!", cd4_cd45ra_path))))),
           parent = "RORyT-TBET-", name = "TEM")
...
cd154_cd137_counts$Status <- factor(cd154_cd137_counts$Status, levels = c("Pneg", "TST+"))
```
...
cd137_counts$Status <- factor(cd137_counts$Status, levels = c("Pneg", "TST+"))
```
...
ccr6_roryt_counts$Status <- factor(ccr6_roryt_counts$Status, levels = c("Pneg", "TST+"))
```
...
nodes <- c("/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/OX40+",
           ...
           "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/Naive",
...
Pull out memory phenotype frequencies of RORyT+TBET- and RORyT-TBET- cells

```{r}
nodes_th17 <- c("/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT+TBET-/Naive",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT+TBET-/TCM",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT+TBET-/TEM",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT+TBET-/TEMRA",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT-TBET-/Naive",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT-TBET-/TCM",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT-TBET-/TEM",
                "/Time/Cells/CD3+CD14-CD19-/Singlets/Live/CD3+ Lymphocytes/CD4 Positive/CD4+/CD4_CD154+_OR_CD137+/RORyT-TBET-/TEMRA")
nodes_short_th17 <- str_replace(nodes_th17, "\\/Time\\/Cells\\/CD3\\+\\CD14\\-\\CD19\\-\\/Singlets\\/Live\\/CD3\\+\\ Lymphocytes\\/CD4 Positive\\/CD4\\+\\/CD4\\_\\CD154\\+\\_\\OR\\_\\CD137\\+\\/RORyT\\+\\TBET\\-\\/", "")
nodes_short_th17 <- str_replace(nodes_short_th17, "\\/Time\\/Cells\\/CD3\\+\\CD14\\-\\CD19\\-\\/Singlets\\/Live\\/CD3\\+\\ Lymphocytes\\/CD4 Positive\\/CD4\\+\\/CD4\\_\\CD154\\+\\_\\OR\\_\\CD137\\+\\/RORyT\\-\\TBET\\-\\/", "")

count_list_th17 <- list()

for(pop in nodes_th17) {
  current_counts <- pData(gs) %>%
    tibble::rownames_to_column("rowname") %>%
    left_join(gs_pop_get_count_fast(gs, subpopulations = pop), by = c("rowname" = "name")) %>%
    dplyr::rename(Subpop = Count) %>%
  ...
  current_counts$Status <- factor(current_counts$Status, levels = c("Pneg", "TST+"))
  count_list_th17[[pop]] <- current_counts
}

names(count_list_th17) <- nodes_short_th17
```

# CD154|CD137

Compare between Pneg vs. TST+.

```{r, fig.width=4, fig.height=5}
cd154_cd137_plots_status <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(cd154_cd137_counts, current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = "CD154+|CD137+",
                                                 y_axis_text = "% CD4 T Cells", y_axis_size = 15,   ylim = c(0, 6))
                                })
...
cd137_plots_status <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(cd137_counts, current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
...
ox40_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[1]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
                                                 ...
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(72, 100))
                                })
...
cxcr3_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[12]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
ccr6_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[13]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
roryt_ccr6_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[14]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
tbet_cxcr3_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[15]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
ifng_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[16]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
il17a_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[17]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
cd45ra_pos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[18]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
cd45ra_neg_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[19]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short[19],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(55, 100))
                                })
...
ccr7_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[20]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
cxcr3_agnos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[21]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
ccr6_agnos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[22]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
...
roryt_ifng_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[23]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short[23],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 1))
                                })
...
ccr6_roryt_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(ccr6_roryt_counts, current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = "CCR6+",
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(70, 100))
                                })
names(ccr6_roryt_plots ) <- stims
ccr6_roryt_plots 
```

# Memory phenotypes of RORyT+TBET- CD154+|CD137+ CD4 T cells
```{r}
roryt_naive_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[1]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[1],
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 20))
                                })
names(roryt_naive_plots ) <- stims
roryt_naive_plots 

roryt_tcm_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[2]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[2],
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(55, 100))
                                })
names(roryt_tcm_plots) <- stims
roryt_tcm_plots 

roryt_tem_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[3]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[3],
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 50))
                                })
names(roryt_tem_plots ) <- stims
roryt_tem_plots 

roryt_temra_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[4]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[4],
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 8))
                                })
names(roryt_temra_plots ) <- stims
roryt_temra_plots 
```

# Memory phenotypes of RORyT-TBET- CD154+|CD137+ CD4 T cells
```{r}
roryt_tbet_dn_naive_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[5]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[5],
                                                 y_axis_text = "% RORyT-TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 75))
                                })
names(roryt_tbet_dn_naive_plots ) <- stims
roryt_tbet_dn_naive_plots 

roryt_tbet_dn_tcm_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[6]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[6],
                                                 y_axis_text = "% RORyT-TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 100))
                                })
names(roryt_tbet_dn_tcm_plots) <- stims
roryt_tbet_dn_tcm_plots 

roryt_tbet_dn_tem_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[7]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[7],
                                                 y_axis_text = "% RORyT-TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 25))
                                })
names(roryt_tbet_dn_tem_plots ) <- stims
roryt_tbet_dn_tem_plots 

roryt_tbet_dn_temra_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list_th17[[8]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("Pneg", "TST+"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short_th17[8],
                                                 y_axis_text = "% RORyT-TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 4))
                                })
names(roryt_tbet_dn_temra_plots ) <- stims
roryt_tbet_dn_temra_plots 
```
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_CD154_CD137_DP_plots_by_stim.pdf"), width=6, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(cd154_cd137_plots_stim[["Pneg"]])
print(cd154_cd137_plots_stim[["TST+"]])
dev.off()
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_Naive_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_naive_plots[["DMSO"]])
print(roryt_naive_plots[["PP1"]])
print(roryt_naive_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TCM_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tcm_plots[["DMSO"]])
print(roryt_tcm_plots[["PP1"]])
print(roryt_tcm_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TEM_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tem_plots[["DMSO"]])
print(roryt_tem_plots[["PP1"]])
print(roryt_tem_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TEMRA_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_temra_plots[["DMSO"]])
print(roryt_temra_plots[["PP1"]])
print(roryt_temra_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TBET_DN_Naive_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tbet_dn_naive_plots[["DMSO"]])
print(roryt_tbet_dn_naive_plots[["PP1"]])
print(roryt_tbet_dn_naive_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TBET_DN_TCM_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tbet_dn_tcm_plots[["DMSO"]])
print(roryt_tbet_dn_tcm_plots[["PP1"]])
print(roryt_tbet_dn_tcm_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TBET_DN_TEM_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tbet_dn_tem_plots[["DMSO"]])
print(roryt_tbet_dn_tem_plots[["PP1"]])
print(roryt_tbet_dn_tem_plots[["TB WCL"]])
dev.off()

cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis/Th_CD4_RORyT_TBET_DN_TEMRA_plots.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
print(roryt_tbet_dn_temra_plots[["DMSO"]])
print(roryt_tbet_dn_temra_plots[["PP1"]])
print(roryt_tbet_dn_temra_plots[["TB WCL"]])
dev.off()
```
