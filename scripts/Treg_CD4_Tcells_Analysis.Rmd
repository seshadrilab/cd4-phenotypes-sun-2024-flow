...
# 
# ox40_pp1_plot <- make_mag_plots(count_list[[nodes_short[1]]], counts_no_outlier = ox40_counts_no_outlier, current_stim = "PP1", num_comparisons = length(stims), groups_to_compare = c("RSTR", "LTBI"),
#                                                  paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Status", subtitle = nodes_short[1],
#                                                  y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(75, 100))
# 
# ox40_plots
# ox40_pp1_plot
