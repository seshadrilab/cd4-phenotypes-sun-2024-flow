---
title: "Th Panel CD4 T cells Analysis by Batch"
author: "Jolie Phan"
output: 
  html_document:
    toc: yes
...
Of CD154+ and/or CD137+ CD4 T cells, analyze the expression of OX40, CTLA-4, CXCR3, CCR6, CD45RA, CCR7, RORyT, TBET, IFNg, and IL17a.
...
if(!dir.exists(here::here("out/Th_CD4_Tcells_Analysis_by_Batch"))) {
  cat(sprintf("Creating folder %s\n", here::here("out/Th_CD4_Tcells_Analysis_by_Batch")))
  dir.create(here::here("out/Th_CD4_Tcells_Analysis_by_Batch"), recursive = T)
}
```
...
ox40_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[1]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 ...
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(72, 100), facet_by = "Status")
                                })
...
roryt_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[8]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 ...
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 25), facet_by = "Status")
                                })
...
roryt_tbet_dn_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[10]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 ...
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 70), facet_by = "Status")
                                })
...
cxcr3_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[12]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[12],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 40), facet_by = "Status")
                                })
...
ccr6_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[13]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[13],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 70), facet_by = "Status")
                                })
...
roryt_ccr6_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[14]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[14],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 20), facet_by = "Status")
                                })
...
tbet_cxcr3_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[15]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[15],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 40), facet_by = "Status")
                                })
...
ifng_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[16]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[16],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 75), facet_by = "Status")
                                })
...
il17a_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[17]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[17],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 14), facet_by = "Status")
                                })
...
cd45ra_pos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[18]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[18],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 50), facet_by = "Status")
                                })
...
cd45ra_neg_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[19]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[19],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(55, 100), facet_by = "Status")
                                })
...
ccr7_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[20]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[20],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(50, 100), facet_by = "Status")
                                })
...
cxcr3_agnos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[21]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[21],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 100), facet_by = "Status")
                                })
...
ccr6_agnos_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[22]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[22],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 100), facet_by = "Status")
                                })
...
roryt_ifng_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(count_list[[nodes_short[23]]], current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"),
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = nodes_short[23],
                                                 y_axis_text = "% CD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(0, 1), facet_by = "Status")
                                })
...
ccr6_roryt_plots <- purrr::pmap(.l = list(stims),
                                .f = function(n) {
                                  make_mag_plots(ccr6_roryt_counts, current_stim = n, num_comparisons = length(stims), groups_to_compare = c("B1", "B2"), 
                                                 paired = FALSE, adjust_p = FALSE, fill_colors = fill_colors, group_by_colname = "Batch", subtitle = "CCR6+",
                                                 y_axis_text = "% RORyT+TBET-\nCD154+|CD137+ CD4 T Cells", y_axis_size = 15,   ylim = c(70, 100), facet_by = "Status")
                                })
...
```{r}
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CD154_CD137_DP_plots_by_Batch.pdf"), width=4, height=5,
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CD137_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_OX40_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CTLA4_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_Naive_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_TCM_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_TEM_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_TEMRA_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_RORyT_TBET_DP_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_RORyT_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_TBET_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_RORyT_TBET_DN_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CXCR3_CCR6_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CXCR3_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CCR6_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_RORyT_CCR6_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_TBET_CXCR3_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_IFNg_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_IL17a_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CD45RA_Pos_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CD45RA_Neg_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CCR7_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CXCR3_agnos_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CCR6_agnos_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_RORyT_IFNg_DP_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
...
cairo_pdf(file=here::here("out/Th_CD4_Tcells_Analysis_by_Batch/Th_CD4_CCR6_of_RORyT_plots_by_Batch.pdf"), width=4, height=5,
          onefile = TRUE, bg = "transparent", family = "Arial") # default unit is inches, default font is Helvetica.
